        ...
        <div class="content">
            ...
            if(isset($_POST['add'])){
                ...
                if(mysqli_num_rows($cek) == 0){
                    if($pass1 == $pass2){
                        $pass = $pass1;
                        $insert = mysqli_query($koneksi, "INSERT INTO mahasiswa(nim, password, nama, tempat_lahir, tanggal_lahir, email, jenis_kelamin, agama, alamat, foto, status)
                                                            VALUES('$nim', '$pass', '$nama', '$tmp', '$tgl', '$email', '$jk', '$agama', '$alamat', 'avatar.png', '$status')") or die(mysqli_error());
                        if($insert){
