                ...
                <div id="page-content">
                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            <h1 class="panel-title">Data Peserta Essay</h1> 
                        </div>
					...
					$cai = "Belum Bayar";
                         $urut = (isset($_GET['id']) ? strtolower($_GET['id']) : NULL); 
                            if($urut){
                                $sql = mysqli_query($koneksi, "SELECT * FROM essay ORDER BY id ASC");
                            }else{
                                $sql = mysqli_query($koneksi, "SELECT * FROM essay ORDER BY id ASC");
                            }
                            if(mysqli_num_rows($sql) == 0){
                                ...
                                while($row = mysqli_fetch_assoc($sql)){
                                    ...
                                    <tr>
                                        ...
                                        <td>'.$row['line'].'</td>
                                        <td>'.$row['email'].'</td>
                                        <td><a href="http://sifest.id/peserta/essay/file/'.$row['file'].'"> <button> Download </button> </a></td> 
