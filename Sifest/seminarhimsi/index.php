...
header ("location:http://adminku.sifest.id");
} 
elseif ($data['level'] == 'lomba') {
  header("location:http://adminhimsi.sifest.id");
} 
                ...
                <div id="page-content">
                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            <h1 class="panel-title">Data Peserta Seminar Yang Belum Membayar</h1> 
                        </div>
					...
					$cai = "Belum Lunas";
                         $urut = (isset($_GET['id']) ? strtolower($_GET['id']) : NULL); 
                            if($urut){
                                $sql = mysqli_query($koneksi, "SELECT * FROM seminar where status like '%".$cai."%' ORDER BY id ASC");
                            }else{
                                $sql = mysqli_query($koneksi, "SELECT * FROM seminar where status like '%".$cai."%' ORDER BY id ASC");
                            }
