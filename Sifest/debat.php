                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h4 class="modal-title">Daftar Peserta Debat</h4>
                                        ...
                                        <div class="modal-body p-4">
											...
											<div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <input type="hidden" class="form-control" name="lomba" value="debat"required="">
                                                    </div>
...
<!--End Modal-->
    ...
    <section class="page-title" style="background-image:url(images/background/2.jpg);">
        <div class="auto-container">
            <span class="float-text">DEBAT TEKNOLOGI</span>
            <h1>LOMBA DEBAT TEKNOLOGI <br> SIFEST 2019</h1>
            ...
            <div class="row">
                ...
                <div class="content-column col-lg-6 col-md-12 col-sm-12">
                    <div class="inner-column">   
                        ...
                        <div class="info-box">
                            <h5>Lomba Debat Teknologi</h5>
                            <div class="text">Debat Teknologi merupakan debat bahasa indonesia dibidang teknologi yang ditujukan untuk mahasiswa (S1/D3) seluruh indonesia. Dalam hal ini peserta akan memaparkan argumentasi dari tema yang telah ditentukan untuk meyakinkan juri bahwa argumentasi yang disampaikan merupakan yang paling baik, logis, dan bermanfaat bagi masyarakat.</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="image-column col-lg-6 col-md-12 col-sm-12">
                    <div class="image-box wow fadeInRight">
                        <figure class="image-box"><img src="images/icons/logo-debat.png" alt=""></figure>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="inner-column" style="background-image: url(images/resource/image-1.png);">
                                <div class="inner">
                                    ...
                                    <div class="info-box date">
                                        ...
                                        <div class="text">1-2/11/2019</div>
                                    </div>

                                    <div class="info-box time">
                                        <span class="icon flaticon-clock-1"></span>
                                        <div class="text">08.00 - Selesai</div>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="event-topics-tabs">
                <div class="tabs-box">
                    ...
                    <ul class="tab-btns tab-buttons clearfix">
                        ...
                        <li data-tab="#tab2" class="tab-btn"><div>Technikal Meeting</div></li>
                        <li data-tab="#tab3" class="tab-btn"><div>Hari Perlombaan</div></li>
                    </ul>
                    ...
                    <div class="tabs-content">
                                ...
                                <div class="content-column col-lg-6 col-md-12 col-sm-12">
                                    <div class="inner-column">
                                       <h4>Pendaftaran</h4>
                                        ...
                                        <div class="text">
                                            <p>Pada tahap ini para peserta melakukan pendaftaran dan melengkapi berkas berkas yang diperlukan. Setelah pendaftaran peserta akan di bagi menjadi 2 sesi. <br>Diharapkan seluruh peserta sudah melakukan DP sebesar Rp:50.000/tim paling lambat H-3 Technikal Meeting dan pelunasan saat Technikal Meeting</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="image-column col-lg-6 col-md-12 col-sm-12">
                        ...
                        <div class="tab" id="tab2">
                            <div class="row">
                                <div class="content-column col-lg-6 col-md-12 col-sm-12">
                                    <div class="inner-column">
                                        <h4>Technikal Meeting</h4>
                                        <span class="date">29/10/2019</span>
                                        <div class="text">
                                            <p>Technikal meeting ini di laksanakan pada Fakultas Ilmu Komputer Universitas Sriwijaya Bukit Palembang. Untuk waktu akan di beritahu setelah pendaftaran dan pelunasan DP</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="image-column col-lg-6 col-md-12 col-sm-12">
                        ...
                        <div class="tab" id="tab3">
                            <div class="row">
                                <div class="content-column col-lg-6 col-md-12 col-sm-12">
                                    <div class="inner-column">
                                        <h4>Hari Perlombaan</h4>
                                        <span class="date">01/11/2019 - 02/11/2019</span>
                                        <div class="text">
                                            <p>Perlombaan debat ini di laksanakan sebanyak dua hari yaitu pada tanggal 01/11/2019 - 02/11/2019 dari jam 8 AM sampai selesai dengan tema yang sudah di tentukan.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="image-column col-lg-6 col-md-12 col-sm-12">
