                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h4 class="modal-title">Daftar Peserta Essay</h4>
                                        ...
                                        <div class="modal-body p-4">
											...
											<div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <input type="hidden" class="form-control" name="lomba" value="essay"required="">
                                                    </div>
...
<!--End Modal-->
    ...
    <section class="page-title" style="background-image:url(images/background/2.jpg);">
        <div class="auto-container">
            <span class="float-text">ESSAY</span>
            <h1>LOMBA ESSAY SIFEST 2019</h1>
            ...
            <div class="row">
                ...
                <div class="content-column col-lg-6 col-md-12 col-sm-12">
                    <div class="inner-column">   
                        ...
                        <div class="info-box">
                            <h5>Lomba Essay</h5>
                            <div class="text">Essay merupakan Kegiatan Kompetisi dimana peserta diberikan kesempatan untuk menyalurkan ide atau konsep sesuai dengan tema yang telah ditentukan oleh panitia. Peserta akan mempresentasikan hasil Essay tersebut pada hari yang telah ditentukan oleh panitia. Lomba ini ditujukan untuk Siswa/i SMA dan Mahasiswa/i Perguruan Tinggi.
                            <br>Tema Essay : "Upaya Generasi Milenial Mewujudkan Indonesia Emas 2045 dalam Inovasi Teknologi Informasi"<br>
                            Sub Tema :<br>
                             1. Pendidikan<br>
                             2. Ekonomi<br>
                             3. Teknologi<br>
                            ...
                            <br>
                            <h5>PENGUMUMAN FINALIS ESSAY</h5>
                            <div class="text">
                                1. Ummu Farwa Shabirah (SMAN 5 Palembang) <br>
                                2. Rizki Ade Ningsih (Universitas Sriwijaya) <br>
                                3. Cici Elna Sari (Universitas Sriwijaya) <br>
                                4. Tiara Dewangga (Universitas Sriwijaya) <br>
                                5. Atika Sekar Ayu (Politeknik Negeri Sriwijaya) <br>
                                6. Muhammad Adrian Syaputra (SMAN 3 Palembang) <br>
                                7. Alek Sander (Universitas Sriwijaya)
                            </div>
                            <br>
                            <h5>PENGUMUMAN PEMENANG ESSAY</h5>
                            <div class="text">
                                1. Cici Elna Sari (Universitas Sriwijaya) Skor 84,475 <br>
                                2. Atika Sekar Ayu (Politeknik Negeri Sriwijaya) Skor 76,55 <br>
                                3. Rizki Ade Ningsih (Universitas Sriwijaya) Skor 76,3
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="image-column col-lg-6 col-md-12 col-sm-12">
                    <div class="image-box wow fadeInRight">
                        <figure class="image-box"><img src="images/icons/logo-essay.png" alt=""></figure>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="inner-column" style="background-image: url(images/resource/image-1.png);">
                                <div class="inner">
                                    <div class="info-box location">
                                        ...
                                        <div class="text">Fakultas Ilmu Komputer, Universitas Sriwijaya Palembang</div>
                                    </div>
                                    ...
                                    <div class="info-box time">
                                        ...
                                        <div class="text"> 08:00 - 12:00</div>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="event-topics-tabs">
                <div class="tabs-box">
                    ...
                    <ul class="tab-btns tab-buttons clearfix">
                        <li data-tab="#tab1" class="tab-btn active-btn"><div>Pengumpulan Karya</div></li>
                        <li data-tab="#tab2" class="tab-btn"><div>Penilaian Juri</div></li>
                    ...
                    <div class="tabs-content">
                        ...
                        <div class="tab active-tab" id="tab1">
                            <div class="row">
                                <div class="content-column col-lg-6 col-md-12 col-sm-12">
                                    <div class="inner-column">
                                        <span class="date">04/10/2019 - 21/10/2019</span>
                                        <h4>Pendaftaran Sekaligus Pengumpulan Karya</h4>
                                        <div class="text">                                            
                                            <p>Pada tahap ini peserta diminta untuk mendaftarkan diri kemudian melakukan pembayaran dan mengirim bukti pembayaran ke cp essay yang telah tertera di guidebook. Peserta yang telah melakukan pembayaran diperbolehkan untuk mengirim karyanya dengan melakukan login di website ini.</p>                                            
                                        </div>
                                    </div>
                                </div>
                                <div class="image-column col-lg-6 col-md-12 col-sm-12">
                        ...
                        <div class="tab" id="tab2">
                            <div class="row">
                                <div class="content-column col-lg-6 col-md-12 col-sm-12">
                                    <div class="inner-column">
                                        <span class="date">22/10/2019 - 26/10/2019</span>
                                        <h4>Penjurian</h4>
                                        <div class="text">                                            
                                            <p>Pada tahap ini setiap karya yang telah dikirim akan diseleksi oleh 3 juri. Bagi peserta yang menjadi finalis diharapkan untuk mempresentasikan karyanya.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="image-column col-lg-6 col-md-12 col-sm-12">
                            ...
                            <div class="row">
                                <div class="content-column col-lg-6 col-md-12 col-sm-12">
                                    <div class="inner-column">
                                        ...
                                        <h4>Final</h4>
                                        <div class="text">                                            
                                            <p>Pada tahap ini para finalis akan mempresentasikan karyanya di hadapan 3 juri dan melakukan sesi tanya jawab.</p>                                            
                                        </div>
                                    </div>
                                </div>
                                <div class="image-column col-lg-6 col-md-12 col-sm-12">
